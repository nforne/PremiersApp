...
namespace Week11_Lab01_PremierApp
{
    internal class Premier
    {
        ...
        public Premier(string name, string life, string constituent, string start, string end, string party)
          => (this.Name, this.Life, this.Constituent, this.Start, this.End, this.Party) = (name, life, constituent, start, end, party);

        public string Key => this.Name.Split().Last();//uses linq to get the last name
